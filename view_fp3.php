...
<body>
  <div class="info-card">
    <h1>Phase 3 Flood Locations</h1>
    <p>Showing the database points for Phase 3 as smaller pulsing markers.</p>
  </div>
  ...
  <script>
    ...
    $phaseFilter = isset($_GET['phase']) ? strtoupper(trim($_GET['phase'])) : 'P3';
