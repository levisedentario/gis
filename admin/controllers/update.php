...
$stmt = $conn->prepare("\n    UPDATE locations\n    SET\n        location_name = ?,\n        latitude = ?,\n        longitude = ?,\n        elevation = NULLIF(?, ''),\n        built_span = NULLIF(?, ''),\n        garbage_accommodation = NULLIF(?, ''),\n        building_density = NULLIF(?, ''),\n        drainage_obstruction = NULLIF(?, ''),\n        drainage_conveyance = NULLIF(?, ''),\n        vegetation_cover = NULLIF(?, ''),\n        structural_condition = NULLIF(?, ''),\n        recommendation = NULLIF(?, ''),\n        hydraulic_capacity = NULLIF(?, ''),\n        impervious = NULLIF(?, ''),\n        infiltration_capacity = NULLIF(?, ''),\n        soil_type = NULLIF(?, ''),\n        structure_type = NULLIF(?, ''),\n        dimensions = NULLIF(?, ''),\n        shape = NULLIF(?, ''),\n        manning_n = NULLIF(?, ''),\n        material = NULLIF(?, ''),\n        slope = NULLIF(?, ''),\n        weather_data_source = NULLIF(?, ''),\n        weather_input = NULLIF(?, ''),\n        rain_intensity = NULLIF(?, ''),\n        rain_intensity_unit = NULLIF(?, ''),\n        precipitation_probability = NULLIF(?, '')\n    WHERE id = ?\n");
