...
<html lang="en">
    ...
    <body>
        <div id="map">
            <?php $activePage = 'phase3'; include '../includes/phase_nav.php'; ?>
        </div>
        ...
        var areaInfoContent = '<section class="area-info-card" aria-label="Flood susceptibility information">' +
            ...
            '</ul>' +
            '<button class="area-live-button" type="button" onclick="window.location.href=\'../../view_fp3.php?phase=P3\'">View Possible Flooded area</button>' +
        '</section>';
        var areaInfoMarker = L.marker(layer_Phase3_3.getBounds().getCenter(), {
            icon: L.divIcon({
