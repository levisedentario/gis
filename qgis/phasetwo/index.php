...
<html lang="en">
    <head>
        ...
        .area-info-button[aria-expanded="true"] {
            background: #115e59;
        }
        .area-info-marker {
    ...
    <body>
        <div id="map">
            <?php $activePage = 'phase2'; include '../includes/phase_nav.php'; ?>
        </div>
        ...
        <script src="data/Phase2_3.js"></script>
        ...
        function pop_Phase2_3(feature, layer) {
            layer.on({
                mouseout: function(e) {
                    if (typeof layer.closePopup == 'function') {
                        layer.closePopup();
        ...
        map.createPane('pane_Phase2_3');
        map.getPane('pane_Phase2_3').style.zIndex = 403;
        map.getPane('pane_Phase2_3').style['mix-blend-mode'] = 'normal';
        var layer_Phase2_3 = new L.geoJson(json_Phase2_3, {
            attribution: '',
            interactive: false,
            dataVar: 'json_Phase2_3',
            layerName: 'layer_Phase2_3',
            pane: 'pane_Phase2_3',
            onEachFeature: pop_Phase2_3,
            style: style_Phase2_3_0,
        });
        bounds_group.addLayer(layer_Phase2_3);
        map.addLayer(layer_Phase2_3);
        var areaInfoContent = '<section class="area-info-card" aria-label="Flood susceptibility information">' +
            ...
            '</ul>' +
            '<button class="area-live-button" type="button" onclick="window.location.href=\'../../view_fp2.php?phase=P2\'">View Possible Flooded area</button>' +
        '</section>';
        var areaInfoMarker = L.marker(layer_Phase2_3.getBounds().getCenter(), {
            icon: L.divIcon({
        ...
        var overlaysTree = [
            {label: '<img src="legend/River_4.png" /> River', layer: layer_River_4},
            {label: '<img src="legend/Phase2_3.png" /> Phase 2', layer: layer_Phase2_3},
