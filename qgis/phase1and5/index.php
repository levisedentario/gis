...
<html lang="en">
    ...
    <body>
        <div id="map">
            <?php $activePage = 'phase1'; include '../includes/phase_nav.php'; ?>
        </div>
        ...
        <script src="data/PH1AND5_3.js"></script>
        ...
        function pop_PH1AND5_3(feature, layer) {
            layer.on({
                mouseout: function(e) {
                    if (typeof layer.closePopup == 'function') {
                        layer.closePopup();
        ...
        map.createPane('pane_PH1AND5_3');
        map.getPane('pane_PH1AND5_3').style.zIndex = 403;
        map.getPane('pane_PH1AND5_3').style['mix-blend-mode'] = 'normal';
        var layer_PH1AND5_3 = new L.geoJson(json_PH1AND5_3, {
            attribution: '',
            interactive: false,
            dataVar: 'json_PH1AND5_3',
            layerName: 'layer_PH1AND5_3',
            pane: 'pane_PH1AND5_3',
            onEachFeature: pop_PH1AND5_3,
            style: style_PH1AND5_3_0,
        });
        bounds_group.addLayer(layer_PH1AND5_3);
        map.addLayer(layer_PH1AND5_3);
        var areaInfoContent = '<section class="area-info-card" aria-label="Flood susceptibility information">' +
            ...
            '</ul>' +
            '<button class="area-live-button" type="button">View Possible Flooded Area</button>' +
        '</section>';
        var areaInfoMarker = L.marker(layer_PH1AND5_3.getBounds().getCenter(), {
            icon: L.divIcon({
        ...
        var overlaysTree = [
            ...
            {label: '<img src="legend/PH1AND5_3.png" /> PH1AND5', layer: layer_PH1AND5_3},
